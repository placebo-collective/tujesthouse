      ...
      <div className="container">
        ...
        <section>
          ...
          <ol>
            ...
            <li>
              <strong>Projekt</strong> – cykl wydarzeń kulturalnych „Tu Jest House” planowany do
              realizacji w okresie maj-wrzesień 2026. Projekt aplikuje o dofinansowanie w ramach
              programu „Kultura – Interwencje 2026” Narodowego Centrum Kultury.
            </li>
            <li>
              <strong>Formularz artystów</strong> – formularz zgłoszeniowy dla artystów chcących
              wziąć udział w open call.
            </li>
            <li>
              <strong>Formularz warsztatów</strong> – formularz rejestracyjny na warsztaty
              edukacyjne w ramach Projektu.
            </li>
            <li>
              <strong>Wydarzenie</strong> – jedno z pięciu spotkań odbywających się w ramach
              Projektu w okresie maj-wrzesień 2026.
            </li>
          </ol>
        </section>
        ...
        <section>
          ...
          <ol>
            ...
            <li>
              Administrator zastrzega sobie prawo do przerw w dostępności Serwisu związanych z
              konserwacją, aktualizacją lub innymi przyczynami technicznymi.
            </li>
            <li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  podawania nieprawdziwych lub wprowadzających w błąd informacji w formularzach.
                </li>
              </ul>
            </li>
          </ol>
        ...
        <section>
          <h2>§ 4. Formularz zgłoszeniowy dla artystów</h2>
          <ol>
            <li>
              Formularz artystów służy do zgłaszania kandydatur do występów w ramach Projektu w
              wybranym mieście.
            </li>
            <li>
              Wypełnienie formularza wymaga podania następujących danych:
              <ul>
            ...
            <li>
              Wysłanie formularza wymaga wyrażenia zgody na przetwarzanie danych osobowych zgodnie z
              Polityką Prywatności.
            </li>
            <li>
              Wysłanie formularza nie gwarantuje udziału w Projekcie. Wybór artystów następuje na
              podstawie merytorycznej oceny zgłoszeń.
            </li>
        ...
        <section>
          ...
          <ol>
            ...
            <li>
              Liczba miejsc na warsztatach może być ograniczona. W przypadku dużego zainteresowania
              priorytet będą miały osoby najwcześniej zgłoszone.
            </li>
            <li>
              Organizator skontaktuje się z uczestnikami drogą mailową w celu potwierdzenia
              uczestnictwa i przekazania szczegółowych informacji.
            </li>
          </ol>
        </section>
        ...
        <section>
          ...
          <ol>
            <li>
              Wszystkie materiały zamieszczone w Serwisie, w tym teksty, grafiki, logotypy, zdjęcia
              i inne elementy, są chronione prawem autorskim i stanowią własność Administratora lub
              podmiotów trzecich, które udzieliły Administratorowi licencji.
            </li>
            <li>
              Kopiowanie, rozpowszechnianie lub inne wykorzystywanie materiałów z Serwisu wymaga
              pisemnej zgody Administratora, z wyjątkiem przypadków dozwolonych przez przepisy
              prawa.
            </li>
            <li>
              Artyści wysyłający formularz zgłoszeniowy udzielają Administratorowi prawa do
              publikacji ich pseudonimu artystycznego, opisu stylu oraz fragmentów nadesłanych
              nagrań wyłącznie w celach promocyjnych Projektu.
            </li>
          </ol>
        </section>
        ...
        <section>
          ...
          <ol>
            <li>
              Administrator dokłada wszelkich starań, aby informacje zamieszczone w Serwisie były
              aktualne i prawdziwe, jednak nie ponosi odpowiedzialności za szkody wynikłe z ich
              wykorzystania.
            </li>
            <li>
            ...
            <li>
              Linki do serwisów zewnętrznych (np. SoundCloud, Mixcloud) zamieszczone w Serwisie mają
              charakter wyłącznie informacyjny. Administrator nie ponosi odpowiedzialności za treści
        ...
        <section>
          ...
          <ol>
            <li>
              ...
              <a href="/polityka-prywatnosci">tujesthouse.pl/polityka-prywatnosci</a>
            </li>
            <li>Administratorem danych osobowych jest Tomasz Bursztyński Software Development.</li>
            <li>
              Dane osobowe są przetwarzane zgodnie z Rozporządzeniem Parlamentu Europejskiego i Rady
        ...
        <section>
          ...
          <ol>
            ...
            <li>
              Wszelkie spory wynikłe z korzystania z Serwisu będą rozstrzygane przez właściwe sądy
              polskie.
            </li>
